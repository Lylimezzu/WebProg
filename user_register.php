...
<form action="user_processregister.php" method="POST">
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="phone" name="phone" required class="mt-1 p-2 border border-gray-300 rounded-lg w-full">
            </div>
            <button type="submit" class="w-full py-2 bg-blue-500 text-white font-bold rounded-lg hover:bg-blue-600 transition duration-300">Register</button>
        </form>
    </div>
</body>
</html>
